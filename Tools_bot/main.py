...
from handlers.tools import handle_tool_action  # Убираем process_tool_id
...
app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, handle_tool_action))  # Обновлено на handle_tool_action
